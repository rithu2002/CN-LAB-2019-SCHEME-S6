...
int main()
{
    ...
    recv(clientsocket,message,sizeof(message),0);//reading the message from the client

    printf("\nThe client has sent.%s",message);
    printf("\nSending message to the client.\n");
    send(clientsocket,"YOUR MESSAGE RECEIVED.",sizeof("YOUR MESSAGE RECEIVED."),0);//sending the message to the client
